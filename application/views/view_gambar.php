...
<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data gambar
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $row['aktif']; ?></td>
      <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit_modal" onclick="edit('<?php echo $row['id']; ?>')">Edit</button>
      <a href="<?php echo base_url(); ?>siswa/hapus/<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin Mau di Hapus?');" >Delete</a></td>
    <?php } ?>
    </tr>
  </tbody>
</table>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="control
    -label">id</label>
    <input type="hidden" class="form-control" name="id" id="id" readonly="readonly" value="<?php echo $autoid; ?>"
    required="required">
  </div>
  <div class="mb-3">
...
<script type="text/javascript">
            function edit(id_nilai){
              ...
              $.ajax({
                type: 'POST',
                data: 'id_nilai=' + id,
                url: '<?php echo base_url(); ?>gambar/edit',
                success: function(data){
                  $('#edit_gambar').html(data);
                }
              });
            }
          </script>
